...
END:VCARD`.trim()
    ...
    */
    ...
    conn.replyy = (jid, text = '', quoted, options) => {
    ...
    */
    ...
    conn.sendButtonDoc = async (jid, content, footerText, button1, id1, quoted, options) => {
      ...
      const buttonMessage = {
        document: { url: "https://wa.me/6285828357727" },
        mimetype: global.doc,
    ...
    conn.sendButtonImgDoc = async (jid, buffer, contentText, footerText, button1, id1, button2, id2, button3, id3, quoted, options) => {
