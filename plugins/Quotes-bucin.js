...
conn.sendButton(m.chat, anu, wm, `💫 𝐍𝐄𝐗𝐓 💫`, `${_p + _Q}`, fkontak, { contextInfo: { externalAdReply: { title: ucapWaktu, body: wm, sourceUrl: '', thumbnail: thumb }}}
)
}
handler.help = ['bucin']
handler.tags = ['quotes']
