...
let handler  = async (m, { conn }) => {
  ...
  let hr = 'https://telegra.ph/file/cf60b26d891aab29019ac.jpg'
 let mv = await( await fetch(hr)).buffer()
 
conn.send3ButtonImg(m.chat, mv, `––––––「 𝐌𝐎𝐓𝐈𝐕𝐀𝐒𝐈 」–––––––\n\n${pickRandom(global.motivasi)}`, wm, `💫 𝐍𝐄𝐗𝐓 💫`, `.motivasi`, `👻 𝐌𝐀𝐊𝐀𝐒𝐈𝐇 👻`, `ok`, `🔖𝐌𝐄𝐍𝐔 🔖`,`.menu`, m)
